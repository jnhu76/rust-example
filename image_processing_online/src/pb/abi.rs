    ...
    impl ResizeType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                ResizeType::SemeCarve => "SEME_CARVE",
            }
        }
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "SEME_CARVE" => Some(Self::SemeCarve),
                _ => None,
            }
        }
    }
...
pub mod filter {
    ...
    impl Filter {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Filter::Unspecifited => "UNSPECIFITED",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "UNSPECIFITED" => Some(Self::Unspecifited),
